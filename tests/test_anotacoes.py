...
class TestCriarAnotacao:
    ...
    def test_criar_anotacao_com_sucesso(self, client, usuario_teste, headers_autenticado):
...
class TestListarAnotacoes:
    ...
    def test_listar_anotacoes_do_usuario(self, client, usuario_teste, headers_autenticado):
        """Deve listar apenas anotações do usuário autenticado"""
        dados_anotacao = {
            "titulo": "Anotação 1",
            "anotacao": "Conteúdo 1"
        }
        client.post("/api/v1/anotacao/", json=dados_anotacao, headers=headers_autenticado)
...
class TestObterAnotacao:
    ...
    def test_obter_anotacao_do_usuario(self, client, usuario_teste, headers_autenticado):
    ...
    def test_obter_anotacao_outro_usuario(self, client, usuario_teste, usuario_teste_2, headers_autenticado, headers_autenticado_usuario_2):
        """Deve retornar 403 se tentar acessar anotação de outro usuário"""
        dados_anotacao = {
            "titulo": "Anotação do Usuário 1",
            "anotacao": "Conteúdo"
        }
        response_criacao = client.post(
            "/api/v1/anotacao/",
...
class TestAtualizarAnotacao:
    ...
    def test_atualizar_anotacao_completa(self, client, usuario_teste, headers_autenticado):
    ...
    def test_atualizar_anotacao_parcial(self, client, usuario_teste, headers_autenticado):
...
class TestDeletarAnotacao:
    ...
    def test_deletar_anotacao_com_sucesso(self, client, usuario_teste, headers_autenticado):
