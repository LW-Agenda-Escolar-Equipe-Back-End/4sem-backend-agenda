...
class TestCriarEvento:
    ...
    def test_criar_evento_tipo_invalido(self, client, usuario_teste, headers_autenticado):
    ...
    def test_criar_evento_duplicado(self, client, usuario_teste, headers_autenticado):
        ...
        client.post("/api/v1/calendario/", json=dados_evento, headers=headers_autenticado)
...
class TestListarEventos:
    ...
    def test_listar_eventos_do_usuario(self, client, usuario_teste, headers_autenticado):
...
class TestObterEvento:
    ...
    def test_obter_evento_outro_usuario(self, client, usuario_teste, usuario_teste_2, headers_autenticado, headers_autenticado_usuario_2):
...
class TestObterEventoPorData:
    ...
    def test_obter_evento_por_data(self, client, usuario_teste, headers_autenticado):
        ...
        response = client.get(
            "/api/v1/calendario/data/2024-12-25",
            headers=headers_autenticado
        )
        
        assert response.status_code == 200

    def test_obter_evento_data_invalida(self, client, usuario_teste, headers_autenticado):
...
class TestAtualizarEvento:
    ...
    def test_atualizar_evento_completo(self, client, usuario_teste, headers_autenticado):
...
class TestDeletarEvento:
    ...
    def test_deletar_evento_com_sucesso(self, client, usuario_teste, headers_autenticado):
