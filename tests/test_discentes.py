...
class TestCriarDiscente:
    ...
    def test_criar_discente_com_sucesso(self, client: TestClient, usuario_teste, headers_autenticado):
    ...
    def test_criar_discente_email_duplicado(self, client: TestClient, usuario_teste, headers_autenticado):
        ...
        client.post("/api/v1/discentes/", json=dados_discente_1, headers=headers_autenticado)
...
class TestListarDiscentes:
    ...
    def test_listar_discentes_do_usuario(self, client: TestClient, usuario_teste, headers_autenticado):
        ...
        client.post("/api/v1/discentes/", json=dados_discente, headers=headers_autenticado)
...
class TestObterDiscente:
    ...
    def test_obter_discente_do_usuario(self, client: TestClient, usuario_teste, headers_autenticado):
        ...
        # Obter
        response = client.get(f"/api/v1/discentes/{id_discente}", headers=headers_autenticado)
        
        assert response.status_code == 200
        assert response.json()["data"]["id_discente"] == id_discente

    def test_obter_discente_outro_usuario(self, client: TestClient, usuario_teste, usuario_teste_2, headers_autenticado, headers_autenticado_usuario_2):
...
class TestAtualizarDiscente:
    ...
    def test_atualizar_discente_completo(self, client: TestClient, usuario_teste, headers_autenticado):
    ...
    def test_atualizar_discente_parcial(self, client: TestClient, usuario_teste, headers_autenticado):
...
class TestDeletarDiscente:
    ...
    def test_deletar_discente_com_sucesso(self, client: TestClient, usuario_teste, headers_autenticado):
    ...
    def test_deletar_discente_outro_usuario(self, client: TestClient, usuario_teste, usuario_teste_2, headers_autenticado, headers_autenticado_usuario_2):
...
class TestObterDiscentePorEmail:
    ...
    def test_obter_discente_por_email(self, client: TestClient, usuario_teste, headers_autenticado):
        ...
        # Obter por email
        response = client.get(
            f"/api/v1/discentes/email/{email_discente}",
            headers=headers_autenticado
        )
