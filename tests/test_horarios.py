...
class TestCriarHorario:
    ...
    def test_criar_horario_com_sucesso(self, client, usuario_teste, headers_autenticado):
    ...
    def test_criar_horario_dia_invalido(self, client, usuario_teste, headers_autenticado):
    ...
    def test_criar_horario_numero_aula_invalido(self, client, usuario_teste, headers_autenticado):
...
class TestListarHorarios:
    ...
    def test_listar_horarios_do_usuario(self, client, usuario_teste, headers_autenticado):
...
class TestObterHorario:
    ...
    def test_obter_horario_do_usuario(self, client, usuario_teste, headers_autenticado):
        ...
        response = client.get(f"/api/v1/horario/{id_horario}", headers=headers_autenticado)
...
class TestAtualizarHorario:
    ...
    def test_atualizar_horario_completo(self, client, usuario_teste, headers_autenticado):
    ...
    def test_atualizar_horario_parcial(self, client, usuario_teste, headers_autenticado):
...
class TestDeletarHorario:
    ...
    def test_deletar_horario_com_sucesso(self, client, usuario_teste, headers_autenticado):
