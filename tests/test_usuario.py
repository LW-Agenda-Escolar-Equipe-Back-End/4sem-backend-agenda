...
class TestRefreshToken:
    ...
    def test_refresh_token_com_sucesso(self, client: TestClient, refresh_token_usuario_teste):
...
class TestCriarUsuario:
    ...
    def test_criar_usuario_email_duplicado(self, client: TestClient, usuario_teste, usuario_teste_data):
    ...
    def test_criar_usuario_username_duplicado(self, client: TestClient, usuario_teste, usuario_teste_data):
...
class TestObterPerfil:
    ...
    def test_obter_perfil_autenticado(self, client: TestClient, usuario_teste, headers_autenticado):
...
class TestAtualizarUsuario:
    ...
    def test_atualizar_usuario_completo(self, client: TestClient, usuario_teste, headers_autenticado):
    ...
    def test_atualizar_usuario_parcial(self, client: TestClient, usuario_teste, headers_autenticado):
...
class TestDeletarUsuario:
    ...
    def test_deletar_usuario_com_sucesso(self, client: TestClient, usuario_teste, headers_autenticado):
...
class TestListarPorInstituicao:
    ...
    def test_listar_usuarios_por_instituicao(self, client: TestClient, usuario_teste, instituicao_teste):
        """Deve listar usuários de uma instituição"""
        response = client.get(f"/api/v1/usuario/instituicao/{instituicao_teste.id_instituicao}")
...
class TestListarPorCurso:
    ...
    def test_listar_usuarios_por_curso(self, client: TestClient, usuario_teste, curso_teste):
